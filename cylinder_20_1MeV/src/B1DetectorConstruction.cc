...
{  
  ...
  // Detector parameters
  //
  G4double detector_rmin = 0.*mm, detector_rmax = 20.*mm;
  G4double detector_hz = 10.*mm;
  ...
  G4Tubs* solidDetector =    
    new G4Tubs("Detector",                    //its name
        detector_rmin, detector_rmax, detector_hz, 
	detector_phimin, detector_phimax);    //its size
